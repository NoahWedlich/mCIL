...
stmt_ptr Statement::make_if_stmt(expr_ptr cond, stmt_ptr if_branch, stmt_ptr top_elif, stmt_ptr else_branch, Position pos)
{
    return stmt_ptr(new IfStatement(cond, if_branch, top_elif, else_branch, pos));
}
